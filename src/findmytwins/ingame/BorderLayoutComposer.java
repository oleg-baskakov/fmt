...
public class BorderLayoutComposer extends GenericForwardComposer{
	...
	public BorderLayoutComposer(){
		menuModel.add(new MenuNode("Function 1","inGame_fn1.zul"));
		menuModel.add(new MenuNode("Function 2","inGame_fn2.zul"));
		menuModel.add(new MenuNode("Function 3","inGame_fn3.zul"));
	}
